          ...
          <div class="form-group row">
            <div class="col">
              ...
              <div class="input-with-upload">
                ...
                <app-file-upload accept="audio/*" label="Audio" [courseId]="courseId" [lessonId]="lessonId" (uploaded)="articleForm.get('audioUrl')?.setValue($event)"></app-file-upload>
            ...
            <div class="col">
              ...
              <div class="input-with-upload">
                ...
                <app-file-upload accept=".vtt" label="VTT" [courseId]="courseId" [lessonId]="lessonId" (uploaded)="articleForm.get('vttUrl')?.setValue($event)"></app-file-upload>
