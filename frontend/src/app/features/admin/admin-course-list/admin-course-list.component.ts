...
@Component({
      ...
      <table class="admin-table" *ngIf="!isLoading()">
        ...
        <tbody cdkDropList (cdkDropListDropped)="onDrop($event)">
          <tr *ngFor="let course of courses()" cdkDrag class="drag-row">
            ...
            <td>
              <div class="actions">
                <button (click)="editCourse(course)" class="action-icon edit" title="Edit">
                ...
                <button (click)="viewLessons(course)" class="action-icon view" title="View Lessons">
                ...
                <button (click)="deleteCourse(course)" class="action-icon delete" title="Delete">
  ...
  styles: [`
    ...
    .action-icon {
      ...
      &.view:hover { background: #eff6ff; border-color: #bfdbfe; color: #3b82f6; }
    }
